...
<tr><td align="right">Admin Username:</td><td><input type="text" name="loginusernameadmin" class="typein" maxlength="255" size="25" value="Admin"></td></tr><tr><td align="right">Admin Password:</td><td><input type="password" name="loginpasswordadmin" class="typein" maxlength="255" size="25" value="admin"></td></tr>
</table>
</td></tr>
