...
<tr bgcolor="#eeeeee"><td>Create&nbsp;Email&nbsp;Sign-up&nbsp;Filter&nbsp;Of:</td><td><select name="emailsignupmethod" class="pickone">
...
<form action="signupemailcontrol.php" method="post">
<table width="600" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">ADD NEW EMAIL ADDRESS OR DOMAIN</td></tr>
<tr bgcolor="#eeeeee"><td>Add&nbsp;To&nbsp;Signup&nbsp;Filter:</td><td><input type="text" name="newemaildomain" size="55" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#d3d3d3"><td colspan="2" align="center">
...
<tr><td align="center" colspan="2"><br>
<table width="600" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#d3d3d3"><td align="center" colspan="3">CURRENT FILTERED EMAIL ADDRESSES AND DOMAINS</td></tr>
<tr bgcolor="#eeeeee"><td align="center">Email/Domain</td><td align="center">Save</td><td align="center">Delete</td></tr>
<?php
	...
	?>
	<form action="signupemailcontrol.php" method="post">
	<tr bgcolor="#eeeeee"><td align="center"><input type="text" name="addemaildomain" size="25" maxlength="255" class="typein" value="<?php echo $emaildomain ?>"></td>
	<td align="center">
