...
if (ans != "")
{
  ...
  if (ans == "email") {
    ...
    litfields = litfields + '<input type="text" name="promotionalsubject" size="55" maxlength="255" class="typein"><br><textarea name="promotionaladbody" id="promotionaladbody" rows="20" cols="52"></textarea>';
...
<table width="80%" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">ADD NEW PROMOTIONAL AD</td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Name:</td><td><input type="text" name="name" size="55" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Type:</td><td><select name="type" id="type" onchange="javascript:setuppromotional(document.theform.type.value)"><option value=""> - Select - </option><option value="banner">Banner</option><option value="email">Email</option></select></td></tr>
<tr bgcolor="#eeeeee">
...
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">
...
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">BANNER</td></tr>
<tr bgcolor="#eeeeee"><td align="center" colspan="2"><a href="<?php echo $domain ?>" target="_blank"><img src="<?php echo $promotionalimage ?>" border="0"></a></td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Name:</td><td><input type="text" name="name" value="<?php echo $name ?>" size="55" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Banner:</td><td><input type="text" name="promotionalimage" value="<?php echo $promotionalimage ?>" size="55" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">
...
?>
<form action="editpromotional.php" method="post" name="form<?php echo $pid ?>" value="form<?php echo $pid ?>">
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">EMAIL</td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Name:</td><td><input type="text" name="name" value="<?php echo $name ?>" size="58" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Subject:</td><td><input type="text" name="promotionalsubject" value="<?php echo $promotionalsubject ?>" size="58" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#eeeeee"><td valign="top">Message:</td><td>
