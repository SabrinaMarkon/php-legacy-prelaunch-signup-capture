...
<form action="editlayout.php" method="post">
<table width="600" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#d3d3d3"><td align="center">Edit adminnav.php File</td></tr>
<tr bgcolor="#eeeeee"><td align="center"><textarea rows="40" cols="80" name="adminnavcontent"><?php echo $adminnav ?></textarea></td></tr>
<tr bgcolor="#d3d3d3"><td align="center"><input type="hidden" name="action" value="saveadminnav">
...
<form action="editlayout.php" method="post">
<table width="600" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#d3d3d3"><td align="center">Edit membernav.php File</td></tr>
<tr bgcolor="#eeeeee"><td align="center"><textarea rows="40" cols="80" name="membernavcontent"><?php echo $membernav ?></textarea></td></tr>
<tr bgcolor="#d3d3d3"><td align="center"><input type="hidden" name="action" value="savemembernav">
<input type="submit" value="SAVE" class="sendit"></form>
</td></tr>
</table>
</td></tr>
...
<form action="editlayout.php" method="post">
<table width="600" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#d3d3d3"><td align="center">Edit styles.css File</td></tr>
<tr bgcolor="#eeeeee"><td align="center"><textarea rows="40" cols="80" name="stylescontent"><?php echo $styles ?></textarea></td></tr>
<tr bgcolor="#d3d3d3"><td align="center"><input type="hidden" name="action" value="savestyles">
<input type="submit" value="SAVE" class="sendit"></form>
</td></tr>
</table>
</td></tr>
