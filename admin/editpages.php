...
$q = "delete from pages where id=\"$deletepageid\"";
$r = mysql_query($q);
...
$newpagetag = $_POST["newpagetag"];
	...
	$dupq = "select * from pages where name=\"$newpagename\"";
	...
	$dupq2 = "select * from pages where tag=\"$newpagetag\"";
	...
	<tr><td colspan="2" align="center"><br><a href="editpages.php">RETURN</a></td></tr>
	</table>
	<br><br>
	<?php
	include "../footer.php";
...
$q = "insert into pages (name,htmlcode,tag) values (\"$newpagename\",'".$newhtmlcode."',\"$newpagetag\")";
$r = mysql_query($q);
####
...
<tr bgcolor="#eeeeee"><td align="center" colspan="2"><div class="heading">Add New Pages</div></td></tr>
<tr bgcolor="#d3d3d3"><td colspan="2">New pages are created with a URL like <?php echo $domain ?>/dynamic.php?page=TAG (where you enter what you want TAG to be in the form below)</td></tr>
<tr bgcolor="#eeeeee"><td>Page Name:</td><td><input type="text" name="newpagename" size="40" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#eeeeee"><td>Tag (no spaces or special characters!):</td><td><input type="text" name="newpagetag" size="40" maxlength="255" class="typein"></td></tr>
<tr bgcolor="#eeeeee"><td align="center" colspan="2"><textarea name="newhtmlcode" id="newhtmlcode" rows="20" cols="70"></textarea></td></tr>
...
<form action="editpages.php" method="post">
<table width="600" border="0" cellpadding="2" cellspacing="2" bgcolor="#989898" align="center">
<tr bgcolor="#eeeeee"><td align="center"><div class="heading">Edit&nbsp;Page&nbsp;HTML</div></td></tr>
...
?>
<option value="<?php echo $pageid ?>||<?php echo $pagename ?>||<?php echo $pagehtmlcode ?>"><?php echo $pagename ?> - URL: <?php echo $domain ?>/dynamic.php?page=<?php echo $pagetag ?></option>
<?php
	}
?>
</select></form></td></tr>
