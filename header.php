<html>
<head>
<title>Demo Prelaunch Member Capture Site Script</title>
...
<link rel="SHORTCUT ICON" href="http://phpsitescripts.com/favicon.ico"> 
</head>
<body>
         ...
         <td>
          <table cellpadding="0" cellspacing="0" border="0" width="960">
             <tr align="center" style='height: 40px;'>
					...
					<td class='divider'></td>
                    <td class='left_inactive'></td><td class='center_inactive'><a href='mailto:<?php echo $adminemail ?>' class='menu'>Contact</a></td><td class='right_inactive'></td>
					<td class='divider'></td>
                    <td class='left_inactive'></td><td class='center_inactive'><a href='http://phpsitescripts.com/index.php?referid=<?php echo $referid ?>' class='menu'>PHPSiteScripts.com</a></td><td class='right_inactive'></td>
					<td class='divider'></td>
                </tr>
            </table></td>
       </tr>
