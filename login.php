...
<tr><td align="right">Username:</td><td><input type="text" name="loginusername" class="typein" maxlength="255" size="25" value="demomember"></td></tr><tr><td align="right">Password:</td><td><input type="password" name="loginpassword" class="typein" maxlength="255" size="25" value="demopass"></td></tr>
</table>
</td></tr>
