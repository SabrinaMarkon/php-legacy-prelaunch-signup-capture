...
<table style="padding-left: 100px;" cellpadding="4" cellspacing="4" border="0" align="center" width="100%">
...
<table cellpadding="4" cellspacing="2" border="0" align="center" width="600" bgcolor="#989898">
<tr bgcolor="#eeeeee"><td valign="top">Affiliate URL:</td><td><a href="<?php echo $domain ?>/index.php?referid=<?php echo $userid ?>" target="_blank"><font color="#009966"><?php echo $domain ?>/index.php?referid=<?php echo $userid ?></a></font></td></tr>
<?php
...
{
?>
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">BANNER ADS</td></tr>
<?php
...
?>
<tr bgcolor="#eeeeee"><td valign="top"><br><?php echo $bannername ?></td><td align="center"><br><a href="<?php echo $domain ?>/index.php?referid=<?php echo $userid ?>" target="_blank"><img src="<?php echo $bannerpromotionalimage ?>" border="0"></a>
...
{
?>
<tr bgcolor="#d3d3d3"><td align="center" colspan="2">EMAIL AD COPY</td></tr>
<?php
...
?>
<tr bgcolor="#eeeeee"><td valign="top"><?php echo $emailname ?></td><td align="center"><center>
